...
export default {
  ...
  data() {
    return {
      ...
      imgHeight: 'height: 90%;',
      picture: "",
      pictureSrc: 'https://api.btstu.cn/sjbz/api.php?lx=dongman&format=images',
      postImgApi: 'https://api.btstu.cn/sjbz/api.php?lx=dongman&format=images'    }
  },
  props: {
    content: {
      type: String,
    ...
    setTopBackStyle: {
      type: String,
      default() {
        return '--poster-back-img: url(https://api.btstu.cn/sjbz/api.php?lx=dongman&format=images);'
      }
    }
  },
  computed: {
  ...
  mounted() {
    ...
    setTimeout(() => {
      ...
      this.qzoneHref = "https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="+href+"&title="+title+"&desc="+content+"&pics=https://api.btstu.cn/sjbz/api.php?lx=dongman&format=images"
      ...
      this.weiboHref = "https://service.weibo.com/share/share.php?url"+href+"&pichttps://https://api.btstu.cn/sjbz/api.php?lx=dongman&format=images"
    },1000)
  },
  watch: {
    getPicture(nV,oV) {
